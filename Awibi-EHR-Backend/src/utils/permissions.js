...
const PERMISSIONS = {
  ...
  // initiation authority for every workflow inside their own facility. Every
  // action remains attributable to the administrator's real user/role in the
  // clinical and audit record; this does not grant platform-wide tenant access.
  ADMIN: {
    ...
    pharmacy: 1, clinical_orders: 1, support: 1, bookings: 1,
    emergency: 1, households: 1,
    patient_demographics_write: 1, vitals: 1, vitals_write: 1,
    clinical_write: 1, prescriptions: 1, prescriptions_write: 1,
    medication_safety: 1, diagnostic_order: 1, diagnostic_process: 1,
    transfer: 1, inventory_write: 1, pharmacy_write: 1,
    nursing: 1, monitoring: 1, monitoring_write: 1, monitoring_review: 1,
    drug_admin: 1, drug_admin_write: 1, handover: 1, handover_write: 1,
    growth: 1, growth_write: 1, emergency_write: 1,
  },
  RECORDS: {
